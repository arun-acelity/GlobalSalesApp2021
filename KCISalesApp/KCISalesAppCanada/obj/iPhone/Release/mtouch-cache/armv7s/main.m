...
extern void *mono_aot_module_KCISalesAppCanada_info;
...
{
	mono_aot_register_module (mono_aot_module_KCISalesAppCanada_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "KCISalesAppCanada.exe";
	mono_use_llvm = TRUE;
	xamarin_log_level = 0;
