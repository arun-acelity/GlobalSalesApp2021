...
{
	public class CustomElementVideo : CustomCellRootElement
	{
		public CustomElementVideo (ElementType myElementToken) : base (myElementToken.Title, myElementToken.Subtitle, myElementToken.Image, myElementToken.Documentfilename)
		{
		...
		protected override UIViewController MakeViewController()
		{
			if ((!(GetContainerTableView().Editing)) && (AppDelegate.IsBeingDownloaded(MyFile) == AppDelegate.DownloadStatus.Unknown)){
				...
				var vc = new CustomVideoPlayer (MyTitle, strfilename, MyFile);
