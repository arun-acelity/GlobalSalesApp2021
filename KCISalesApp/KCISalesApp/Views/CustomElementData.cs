...
{
	public class CustomElementData : CustomCellRootElement
	{
		public CustomElementData (ElementType myElementToken) : base (myElementToken.Title, myElementToken.Subtitle, myElementToken.Image, myElementToken.Documentfilename)
		{
