...
{
	public class CustomElementDocumentWebView : CustomCellRootElement
	{
		public CustomElementDocumentWebView (ElementType myElementToken) : base (myElementToken.Title, myElementToken.Subtitle, myElementToken.Image, myElementToken.Documentfilename)
		{
