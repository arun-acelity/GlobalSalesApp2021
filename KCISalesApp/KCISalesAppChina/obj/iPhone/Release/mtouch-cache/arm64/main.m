...
extern void *mono_aot_module_KCISalesAppChina_info;
...
{
	mono_aot_register_module (mono_aot_module_KCISalesAppChina_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "KCISalesAppChina.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
