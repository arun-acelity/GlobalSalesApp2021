...
@implementation KCISalesApp_CustomUIDocumentInteractionController {
	...
	-(BOOL) presentOpenInMenuFromBarButtonItem:(UIBarButtonItem *)p0 animated:(BOOL)p1
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, p0, p1, 0x2100);
	}

	-(BOOL) presentOpenInMenuFromRect:(CGRect)p0 inView:(UIView *)p1 animated:(BOOL)p2
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, p1, p2, 0x2200);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, p0, p1, 0x2400);
	}
	...
	-(id) init
	{
		...
		id rv = native_to_managed_trampoline_4 (self, _cmd, &managed_method, &call_super, 0x2000);
		if (call_super && rv) {
...
@implementation KCISalesApp_CustomDocumentInteractionDelegate {
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_5 (self, _cmd, &managed_method, p0, 0x17500);
	}

	-(UIView *) documentInteractionControllerViewForPreview:(UIDocumentInteractionController *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, 0x17600);
	}

	-(CGRect) documentInteractionControllerRectForPreview:(UIDocumentInteractionController *)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_7 (self, _cmd, &managed_method, p0, 0x17700);
	}
...
@implementation KCISalesApp_CustomTextContentView {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x1AC00);
	}

	-(void) didRotateFromInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, 0x1AE00);
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x1AF00);
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x1B000);
	}
...
@implementation KCISalesApp_CustomDialogViewController {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x15800);
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x16400);
	}

	-(void) willRotateToInterfaceOrientation:(NSInteger)p0 duration:(double)p1
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_15 (self, _cmd, &managed_method, p0, p1, 0x16600);
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x16700);
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x16900);
	}
...
@implementation KCISalesApp_CustomCell {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x14700);
	}
...
@implementation KCISalesApp_CustomPicture {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x19200);
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x19900);
	}

	-(void) didRotateFromInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, 0x19B00);
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x19C00);
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x19D00);
	}

	-(BOOL) shouldAutorotateToInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, 0x19E00);
	}

	-(BOOL) shouldAutorotate
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_16 (self, _cmd, &managed_method, 0x19F00);
	}
...
@implementation KCISalesApp_CustomVideoPlayer {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x1B200);
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x1B900);
	}

	-(void) didRotateFromInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, 0x1BB00);
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x1BC00);
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x1BD00);
	}

	-(BOOL) shouldAutorotateToInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, 0x1BE00);
	}

	-(BOOL) shouldAutorotate
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_16 (self, _cmd, &managed_method, 0x1BF00);
	}
...
@implementation KCISalesApp_CustomWebView {
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x1C200);
	}

	-(void) viewWillDisappear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x1C900);
	}

	-(void) didRotateFromInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_9 (self, _cmd, &managed_method, p0, 0x1CB00);
	}

	-(void) didReceiveMemoryWarning
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_8 (self, _cmd, &managed_method, 0x1CC00);
	}

	-(void) viewWillAppear:(BOOL)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_10 (self, _cmd, &managed_method, p0, 0x1CD00);
	}

	-(BOOL) shouldAutorotateToInterfaceOrientation:(NSInteger)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, 0x1CE00);
	}

	-(BOOL) shouldAutorotate
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_16 (self, _cmd, &managed_method, 0x1CF00);
	}
...
@end
	...
	static MTClassMap __xamarin_class_map [] = {
		...
		{ NULL, 0x400 /* #2 'KCISalesApp_CustomUIDocumentInteractionController' => 'KCISalesApp.CustomUIDocumentInteractionController, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0x3300 /* #4 'KCISalesApp_CustomDocumentInteractionDelegate' => 'KCISalesApp.CustomDocumentInteractionDelegate, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0x4300 /* #7 'KCISalesApp_CustomTextContentView' => 'KCISalesApp.CustomTextContentView, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xCF04 /* #8 'UIView' => 'UIKit.UIView, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x4900 /* #9 'KCISalesApp_SectionCredits' => 'KCISalesApp.SectionCredits, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4A00 /* #10 'KCISalesApp_SectionHeader' => 'KCISalesApp.SectionHeader, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xF104 /* #11 'UIApplicationDelegate' => 'UIKit.UIApplicationDelegate, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x200 /* #12 'AppDelegate' => 'KCISalesApp.AppDelegate, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0x3200 /* #15 'KCISalesApp_CustomDialogViewController' => 'KCISalesApp.CustomDialogViewController, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x2E00 /* #16 'KCISalesApp_AppFilesCustomDialogViewController' => 'KCISalesApp.AppFilesCustomDialogViewController, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0x6600 /* #19 'KCISalesApp_CustomCell_FavButton' => 'KCISalesApp.CustomCell+FavButton, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x6700 /* #20 'KCISalesApp_CustomCell_EmailButton' => 'KCISalesApp.CustomCell+EmailButton, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x6800 /* #21 'KCISalesApp_CustomCell_SelectButton' => 'KCISalesApp.CustomCell+SelectButton, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xC404 /* #22 'UITableViewCell' => 'UIKit.UITableViewCell, Xamarin.iOS' */, (MTTypeFlags) (0) /* None */ },
		{ NULL, 0x2F00 /* #23 'KCISalesApp_CustomCell' => 'KCISalesApp.CustomCell, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4000 /* #24 'KCISalesApp_CustomPicture' => 'KCISalesApp.CustomPicture, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x7500 /* #25 'KCISalesApp_CustomSectionCredits_CustomSectionCell' => 'KCISalesApp.CustomSectionCredits+CustomSectionCell, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4400 /* #26 'KCISalesApp_CustomVideoPlayer' => 'KCISalesApp.CustomVideoPlayer, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4500 /* #27 'KCISalesApp_CustomWebView' => 'KCISalesApp.CustomWebView, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4600 /* #28 'KCISalesApp_MyFavoriteListCustomDialogViewController' => 'KCISalesApp.MyFavoriteListCustomDialogViewController, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4700 /* #29 'KCISalesApp_MyFavoritesListsCustomDialogViewController' => 'KCISalesApp.MyFavoritesListsCustomDialogViewController, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x4800 /* #30 'KCISalesApp_MyFilesCustomDialogViewController' => 'KCISalesApp.MyFilesCustomDialogViewController, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0x5E00 /* #34 'KCISalesApp_AppFilesCustomDialogViewController_CustomEditingSource' => 'KCISalesApp.AppFilesCustomDialogViewController+CustomEditingSource, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x7800 /* #35 'KCISalesApp_MyFavoriteListCustomDialogViewController_CustomEditingSource' => 'KCISalesApp.MyFavoriteListCustomDialogViewController+CustomEditingSource, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x7F00 /* #36 'KCISalesApp_MyFavoritesListsCustomDialogViewController_CustomEditingSource' => 'KCISalesApp.MyFavoritesListsCustomDialogViewController+CustomEditingSource, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x8A00 /* #37 'KCISalesApp_MyFilesCustomDialogViewController_CustomEditingSource' => 'KCISalesApp.MyFilesCustomDialogViewController+CustomEditingSource, KCISalesAppSingapore' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		...
		{ NULL, 0x290C /* #137 'MonoTouch_Dialog_MessageSummaryView' => 'MonoTouch.Dialog.MessageSummaryView, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x370C /* #138 'MonoTouch_Dialog_RefreshTableHeaderView' => 'MonoTouch.Dialog.RefreshTableHeaderView, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x390C /* #139 'MonoTouch_Dialog_GlassButton' => 'MonoTouch.Dialog.GlassButton, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x60C /* #140 'MonoTouch_Dialog_BaseBooleanImageElement_TextWithImageCellView' => 'MonoTouch.Dialog.BaseBooleanImageElement+TextWithImageCellView, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x90C /* #141 'MonoTouch_Dialog_HtmlElement_WebViewController' => 'MonoTouch.Dialog.HtmlElement+WebViewController, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x150C /* #142 'MonoTouch_Dialog_ImageElement_MyDelegate' => 'MonoTouch.Dialog.ImageElement+MyDelegate, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x190C /* #143 'MonoTouch_Dialog_DateTimeElement_MyViewController' => 'MonoTouch.Dialog.DateTimeElement+MyViewController, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x250C /* #144 'MonoTouch_Dialog_DialogViewController_SearchDelegate' => 'MonoTouch.Dialog.DialogViewController+SearchDelegate, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x270C /* #145 'MonoTouch_Dialog_DialogViewController_SizingSource' => 'MonoTouch.Dialog.DialogViewController+SizingSource, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x2B0C /* #146 'MonoTouch_Dialog_MessageElement_MessageCell' => 'MonoTouch.Dialog.MessageElement+MessageCell, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x2D0C /* #147 'MonoTouch_Dialog_OwnerDrawnElement_OwnerDrawnCell' => 'MonoTouch.Dialog.OwnerDrawnElement+OwnerDrawnCell, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x2E0C /* #148 'MonoTouch_Dialog_OwnerDrawnElement_OwnerDrawnCellView' => 'MonoTouch.Dialog.OwnerDrawnElement+OwnerDrawnCellView, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x300C /* #149 'MonoTouch_Dialog_JsonElement_ConnectionDelegate' => 'MonoTouch.Dialog.JsonElement+ConnectionDelegate, MonoTouch.Dialog-1' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xB14 /* #150 'MBProgressHUDDelegate' => 'MBProgressHUD.MBProgressHUDDelegate, MBProgressHUD' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0x614 /* #151 'MBProgressHUD_MTMBProgressHUD__MBProgressHUDDelegate' => 'MBProgressHUD.MTMBProgressHUD+_MBProgressHUDDelegate, MBProgressHUD' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x714 /* #152 'MBProgressHUD_MTMBProgressHUD_MTMBProgressHUDAppearance' => 'MBProgressHUD.MTMBProgressHUD+MTMBProgressHUDAppearance, MBProgressHUD' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0x514 /* #153 'MBProgressHUD' => 'MBProgressHUD.MTMBProgressHUD, MBProgressHUD' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0xD14 /* #154 'MBProgressHUD_MBRoundProgressView_MBRoundProgressViewAppearance' => 'MBProgressHUD.MBRoundProgressView+MBRoundProgressViewAppearance, MBProgressHUD' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xC14 /* #155 'MBRoundProgressView' => 'MBProgressHUD.MBRoundProgressView, MBProgressHUD' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0xF14 /* #156 'MBProgressHUD_MBBarProgressView_MBBarProgressViewAppearance' => 'MBProgressHUD.MBBarProgressView+MBBarProgressViewAppearance, MBProgressHUD' */, (MTTypeFlags) (3) /* CustomType, UserType */ },
		{ NULL, 0xE14 /* #157 'MBBarProgressView' => 'MBProgressHUD.MBBarProgressView, MBProgressHUD' */, (MTTypeFlags) (1) /* CustomType */ },
		{ NULL, 0 },
	};

	static const char *__xamarin_registration_assemblies []= {
		"KCISalesAppSingapore", 
		"mscorlib", 
		"Xamarin.iOS", 
		"System", 
		"Mono.Security", 
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [137].handle = [MonoTouch_Dialog_MessageSummaryView class];
	__xamarin_class_map [138].handle = [MonoTouch_Dialog_RefreshTableHeaderView class];
	__xamarin_class_map [139].handle = [MonoTouch_Dialog_GlassButton class];
	__xamarin_class_map [140].handle = [MonoTouch_Dialog_BaseBooleanImageElement_TextWithImageCellView class];
	__xamarin_class_map [141].handle = [MonoTouch_Dialog_HtmlElement_WebViewController class];
	__xamarin_class_map [142].handle = [MonoTouch_Dialog_ImageElement_MyDelegate class];
	__xamarin_class_map [143].handle = [MonoTouch_Dialog_DateTimeElement_MyViewController class];
	__xamarin_class_map [144].handle = [MonoTouch_Dialog_DialogViewController_SearchDelegate class];
	__xamarin_class_map [145].handle = [MonoTouch_Dialog_DialogViewController_SizingSource class];
	__xamarin_class_map [146].handle = [MonoTouch_Dialog_MessageElement_MessageCell class];
	__xamarin_class_map [147].handle = [MonoTouch_Dialog_OwnerDrawnElement_OwnerDrawnCell class];
	__xamarin_class_map [148].handle = [MonoTouch_Dialog_OwnerDrawnElement_OwnerDrawnCellView class];
	__xamarin_class_map [149].handle = [MonoTouch_Dialog_JsonElement_ConnectionDelegate class];
	__xamarin_class_map [150].handle = [MBProgressHUDDelegate class];
	__xamarin_class_map [151].handle = [MBProgressHUD_MTMBProgressHUD__MBProgressHUDDelegate class];
	__xamarin_class_map [152].handle = [MBProgressHUD_MTMBProgressHUD_MTMBProgressHUDAppearance class];
	__xamarin_class_map [153].handle = [MBProgressHUD class];
	__xamarin_class_map [154].handle = [MBProgressHUD_MBRoundProgressView_MBRoundProgressViewAppearance class];
	__xamarin_class_map [155].handle = [MBRoundProgressView class];
	__xamarin_class_map [156].handle = [MBProgressHUD_MBBarProgressView_MBBarProgressViewAppearance class];
	__xamarin_class_map [157].handle = [MBBarProgressView class];
